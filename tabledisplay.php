...
<body style="background-color: rgb(255,250,205)">
    ...
    <br>
    <fieldset>
                <legend><h1><i class="fa fa-edit" style="font-size:32px"></i>MENU DETAILS</h1></legend>
...
$result=mysqli_query($con,"SELECT id,item_name,price FROM edit_menu");
