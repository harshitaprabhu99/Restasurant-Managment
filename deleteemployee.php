    ...
    <section>
          <div class="container">
                <div class="block-heading">
                    <h2 class="text-info"><i class="fa fa-trash" style="font-size:32px"></i>Delete Employee</h2>
                </div>
            </div>
            ...
            <div id="view" style="position: absolute;top:200px;left:600px;"><b><i><a href="displayemployee.php" align="center">Employee Details</a></i></b>
                    ...
                    <center>
                        <table border="4" cellpadding="10" cellspacing="10">
                           ...
                           <br><br>     <TH align="center" color="white">Select the employee name</TH>
                                <td><select name="ename" onblur="myFunction(this.value)">
                                    <?php
...
if(isset($_POST["submit"])){
    if(!empty($_POST['ename'])) {
        ...
        $query=mysqli_query($con,"SELECT * FROM `employee` WHERE ename='".$ename."'");
...
<script type="text/javascript">
    alert("You have deleted the employee succesfully ");
</script>
<?php
echo "Employee  deleted succesfully";
    ...
    ?>
    <script type="text/javascript">
        alert("Failed to delete the employee from the employee table. Try again! ");
    </script>
    <?php
    echo "Failure";
}
